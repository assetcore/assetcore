...
##### Clone the Source
    ...
    mkdir -p ~/assetcore
    git clone git://github.com/assetcore/assetcore.git ~/assetcore/current
    cd assetcore/current
...
**Passenger:**
    ...
    sudo ln -s /home/deploy/assetcore/current/config/nginx.conf /etc/nginx/conf.d/assetcore.conf
