ADMIN_EMAIL = 'admin@assetcore.dev'
...
if Rails.env == 'development'
  ...
  foo = Identity.create(email: 'foo@assetcore.dev', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
  ...
  bar = Identity.create(email: 'bar@assetcore.dev', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
