AssetCoreModel = @AssetCoreModel or require('assetcore_model')
$      = AssetCoreModel.$
Model  = AssetCoreModel.Model
Queue  = $({})
...
class Singleton extends Base
  ...
  recordResponse: (options = {}) =>
    (data, status, xhr) =>
      ...
      Ajax.disable =>
        unless AssetCoreModel.isBlank(data) or @record.destroyed
