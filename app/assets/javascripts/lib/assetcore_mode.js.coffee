...
AssetCoreModel = @AssetCoreModel= {}
module?.exports  = AssetCoreModel

AssetCoreModel.version    = '1.3.2.customizatiion'
AssetCoreModel.isArray    = isArray
AssetCoreModel.isBlank    = isBlank
AssetCoreModel.$          = $
AssetCoreModel.Events     = Events
AssetCoreModel.Log        = Log
AssetCoreModel.Module     = Module
AssetCoreModel.Model      = Model

# Global events

Module.extend.call(AssetCoreModel, Events)
